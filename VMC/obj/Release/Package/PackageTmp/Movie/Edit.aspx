<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="VMC.Movie.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    <ol class="breadcrumb">
        <li><a href="/"><i class="fa fa-home"></i></a></li>
        <li><a href="/Movie">Danh sách phim</a></li>
        <li class="active">Thay đổi phim</li>
    </ol>
</asp:Content>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="heading" style="text-transform: uppercase;">
                    ...
                    Thay đổi phim
                        <a class="btn btn-sm btn-primary-outline pull-right" href="/Movie/add">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtname" runat="server" CssClass="form-control" placeholder="Tên phim"></asp:TextBox>
                    <span class="error">
                        <asp:Label ID="lblname" runat="server" Text=""></asp:Label></span>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Tên phim gốc</label>
                    <asp:TextBox ID="txtfullname" runat="server" CssClass="form-control" placeholder="Tên phim gốc"></asp:TextBox>
                    <span class="error">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control type">
                        <asp:ListItem Text="Phim lẻ" Value="0"></asp:ListItem>
                        <asp:ListItem Text="Phim bộ" Value="1"></asp:ListItem>
                    </asp:DropDownList>
                </div>
                <div class="form-group">
                ...
                <div class="form-group othertag">
                    <label for="exampleInputEmail1">Diễn viên</label>
                    <asp:ListBox ID="lbactor" runat="server" CssClass="form-control js-example-basic-multiple js-states form-control select2-hidden-accessible" aria-hidden="true" TabIndex="-1" multiple="multiple" SelectionMode="Multiple"></asp:ListBox>
                </div>
                <div class="form-group othertag">
                    <label for="exampleInputEmail1">Đạo diễn</label>
                    <asp:ListBox ID="lbdirector" runat="server" CssClass="form-control js-example-basic-multiple js-states form-control select2-hidden-accessible" aria-hidden="true" TabIndex="-1" multiple="multiple" SelectionMode="Multiple"></asp:ListBox>
                </div>
                <div class="form-group othertag">
                    <label for="exampleInputEmail1">Quốc gia</label>
                    <asp:ListBox ID="lbcountry" runat="server" CssClass="form-control js-example-basic-multiple js-states form-control select2-hidden-accessible" aria-hidden="true" TabIndex="-1" multiple="multiple" SelectionMode="Multiple"></asp:ListBox>
                </div>
                <div class="form-group">
