<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="VMC.Movie.Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    ...
    <div class="alert alert-danger alert-dismissible fade in" role="alert">
        ...
        <strong>Lỗi!</strong>
        Phim chưa thêm được vui lòng kiểm tra lại chuỗi nhập.
    </div>
    <% } %>
    <% if (success == 1)
       { %>
