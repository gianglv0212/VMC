<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="VMC.Actor.Add" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
	    <div class="heading" style="text-transform:uppercase;">
	      ...
	      <div class="form-group">
              <asp:Button ID="btnactor" runat="server" Text="Thêm mới" CssClass="btn btn-success pull-right" OnClick="btnactor_Click" />
