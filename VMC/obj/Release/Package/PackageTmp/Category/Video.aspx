<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Video.aspx.cs" Inherits="VMC.Category.Video" EnableEventValidation="false" %>


<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    <ol class="breadcrumb">
        <li><a href="/"><i class="fa fa-home"></i></a></li>
        <li class="active">Danh sách thể loại video</li>
    </ol>
</asp:Content>
    ...
    <div class="col-md-9">
      <div class="subcontent">
        <div class="heading" style="text-transform:uppercase;">
          ...
          Danh sách thể loại
          <a class="btn btn-sm btn-primary-outline pull-right" href="/Category/Add">
        ...
        <div class="table-responsive">
            <asp:GridView ID="grvList" CssClass="table table-bordered" runat="server" 
                AutoGenerateColumns="False" OnRowDataBound="grvList_RowDataBound" 
                AllowPaging="True" OnPageIndexChanging="grvList_PageIndexChanging" 
                PageSize="100" OnSelectedIndexChanged="grvList_SelectedIndexChanged"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Chức năng" ItemStyle-Width="15%">
                        <ItemTemplate>
                            <asp:HyperLink runat="server" CssClass="edit-row btn btn-primary" ID="HyperLink1" NavigateUrl='<%# "Edit?ID=" + Eval("id") + "&type=1"%>' Text="Thay đổi">
