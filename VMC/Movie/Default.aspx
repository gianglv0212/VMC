<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="VMC.Movie.Default" EnableViewState="true" %>
    ...
    <div class="row">
                    ...
                    <div id="collapsethree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingthree">
                        <div class="panel-body">
                            ...
                            <asp:Repeater ID="rptCate" runat="server">
                                ...
                                <ItemTemplate>
                                    <li class="list-group-item" data-id="<%# Eval("id") %>" onclick="vodCateSelect('/Movie?',this)">
        ...
        <a class="btn btn-sm btn-primary-outline pull-right" href="/Movie/Add">
            ...
            <div class="table-responsive">
                <asp:GridView ID="grvList" CssClass="table" runat="server" DataKeyNames="id" BorderWidth="0"
                    AutoGenerateColumns="False" OnRowDataBound="grvList_RowDataBound" AllowPaging="True"
                    HeaderStyle-CssClass="table-header" ShowHeaderWhenEmpty="True" EmptyDataText="Không có dữ liệu được tìm kiếm"
                    OnRowCommand="grvList_RowCommand" OnPageIndexChanging="grvList_PageIndexChanging" PageSize="20">
                    <Columns>
                        ...
                        <asp:BoundField DataField="uname" HeaderText="Người tạo" ItemStyle-Width="10%">
                        ...
                        <asp:TemplateField HeaderText="Chức năng" ItemStyle-Width="10%">
                            <ItemTemplate>
                                ...
                                <span class="glyphicon glyphicon-cog"></span>Hạ phim
                                </asp:LinkButton>
                                ...
                                <span class="fa fa-trash-o"></span>Xóa phim
                                </asp:LinkButton>
                            </ItemTemplate>
