<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="VMC.Director.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    <ol class="breadcrumb">
        <li><a href="/"><i class="fa fa-home"></i></a></li>
        <li><a href="/Director">Danh sách đạo diễn</a></li>
    ...
    <div class="row">
	    <div class="heading" style="text-transform:uppercase;">
	      ...
	      <div class="form-group">
              ...
              <asp:Button ID="btndirector" runat="server" Text="Thay đổi" CssClass="btn btn-success pull-right" OnClick="btndirector_Click" />
